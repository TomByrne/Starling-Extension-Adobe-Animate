...
class MovieFrame
{
    ...
    private var _actions : Array<MovieFrameAction>;
    
    public function new()
    {
    }
    
    public function addAction(action : MovieFrameAction) : Void
    {
        if (action == null)
        {
    ...
    public function removeAction(action : MovieFrameAction) : Void
    {
        if (_actions != null)
        {
    ...
    public function executeActions(target : DisplayObject, frameID : Int) : Void
    {
        if (_actions != null)
        {
            ...
            while (i < len)
            {
                var action : MovieFrameAction = _actions[i];
